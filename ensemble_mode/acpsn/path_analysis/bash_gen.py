...
def gen_sh_file(data, output_sh, input_file, path_plot_sh, pdb_file):
    ...
    output_sh: string
        Name of output commands sh file
    input_file: string
        Name of input file
    path_plot_sh: str
        Name of output plot sh file
    pdb_file: str   
        Name of PDB file 
    Returns 
    ----------
...
def main():
    ...
    parser.add_argument('-pdb', dest='pdb_file', required=True, help='PDB file to use as topology.')
    ...
    gen_sh_file(data, args.output_sh, args.input_file, args.path_plot_sh, args.pdb_file)
