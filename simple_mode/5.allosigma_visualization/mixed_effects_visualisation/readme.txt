...
# 2.MAVISp csv file available (e.g. GENENAME-simple_mode.csv). You can find the MAVISp this file in the downstream_analysis folder of the curated MAVISp protein of choice. 
