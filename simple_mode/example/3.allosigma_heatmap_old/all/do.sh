...
python distribution_plot.py dh_up_mutations.tsv dh_up_mutations_distribution.pdf log
python distribution_plot.py dh_down_mutations.tsv dh_down_mutations_distribution.pdf log
python analyze_free_energies.py dh_down_mutations.tsv dh_down_mutations_analysis
python analyze_free_energies.py dh_up_mutations.tsv dh_up_mutations_analysis
python threshold.py dh_up_mutations.tsv --output_plot dh_distribution_with_thresholds_UP.png --output_thresholds dh_threshold_UP.txt
python threshold.py dh_down_mutations.tsv --output_plot dh_distribution_with_thresholds_DOWN.png --output_thresholds dh_thresholds_DOWN.txt
