...
4.allosigma_filtering_pockets where the filtering step based on distances, absolute values of allosteric free energy, solvent accessibility and pockets is carried out

4.allosigma_filtering_cofactor where the filtering considers manually provided cofactor sites as response sites
