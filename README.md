...
In the folder simple_mode:

The first protocol is based on data from AlloSigMA2. This protocol is also applied as workflow for the LONG_RANGE modules of the MAVISP framework for variant effects in the simple mode (https://www.biorxiv.org/content/10.1101/2022.10.22.513328v4).


In the folder ensemble_mode:
