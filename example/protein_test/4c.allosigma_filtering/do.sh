...
../../../../4c.allosigma_filtering/allosigma-filtering -s $1 -i up_mutations.tsv -t 2 -d fraction -f 0.9  -a 20 --pocket
../../../../4c.allosigma_filtering/allosigma-filtering -s $1 -i down_mutations.tsv -t 2 -d fraction -f 0.9  -a 20 --pocket
